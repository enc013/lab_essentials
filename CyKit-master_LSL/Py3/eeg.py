...
CHANNEL_NUM = 14
srate = 256
info = StreamInfo('Emotiv-CyKIT', 'EEG', CHANNEL_NUM, srate, 'float32')

# Appending some Meta Data:
info.desc().append_child_value("manufacturer", "Emotiv")
channels = info.desc().append_child('channels')
for c in ["F3", "FC5", "AF3", "F7", "T7", "P7", "O1", "O2", "P8", "T8", "F8", "AF4", "FC6", "F4"]:
                ...
                try:
                    ...
                    if self.KeyModel == 6 or self.KeyModel == 5:
                        ...
                        if self.format < 1:
                            ...
                            #LSL Pushing Sammples
                            s = [float(x) for x in packet_data.split(self.delimiter)]
